...
export const componentRegistry = [
  {
    ...
    fields: [
      ...
      { path: 'overlay', label: 'Aplicar overlay', type: 'boolean', helpText: 'Melhora a legibilidade do texto sobre a mídia.' },
      ...
      { path: 'titleFontSizeDesktop', label: 'Título • tamanho desktop', type: 'text', placeholder: 'herda do tema' },
      { path: 'titleFontSizeMobile', label: 'Título • tamanho mobile', type: 'text', placeholder: 'herda do tema' },
      { path: 'titleLineHeightDesktop', label: 'Título • altura linha desktop', type: 'text', placeholder: 'herda do tema' },
      { path: 'titleLineHeightMobile', label: 'Título • altura linha mobile', type: 'text', placeholder: 'herda do tema' },
      { path: 'subtitleFontSizeDesktop', label: 'Subtítulo • tamanho desktop', type: 'text', placeholder: 'herda do tema' },
      { path: 'subtitleFontSizeMobile', label: 'Subtítulo • tamanho mobile', type: 'text', placeholder: 'herda do tema' },
      { path: 'subtitleLineHeightDesktop', label: 'Subtítulo • altura linha desktop', type: 'text', placeholder: 'herda do tema' },
      { path: 'subtitleLineHeightMobile', label: 'Subtítulo • altura linha mobile', type: 'text', placeholder: 'herda do tema' }
    ]
  },
  {
    type: 'header-caotico',
    ...
    fields: [
      ...
      { path: 'overlayOpacity', label: 'Opacidade do overlay', type: 'number', min: 0, max: 1, step: 0.05 },
  ...
  },
  {
    ...
    fields: [
      ...
      { path: 'textAlign', label: 'Alinhamento texto desktop', type: 'select', options: [
        { label: 'Centro', value: 'center' },
        { label: 'Esquerda', value: 'left' },
        { label: 'Direita', value: 'right' }
      ] },
      { path: 'textAlignMobile', label: 'Alinhamento texto mobile', type: 'select', options: [
        { label: 'Centro', value: 'center' },
        { label: 'Esquerda', value: 'left' },
        { label: 'Direita', value: 'right' }
      ] },
  ...
  },
  {
    ...
    fields: [
      ...
      { path: 'fontSizeDesktop', label: 'Tamanho desktop', type: 'text', placeholder: 'herda do tema' },
      { path: 'fontSizeMobile', label: 'Tamanho mobile', type: 'text', placeholder: 'herda do tema' },
      { path: 'lineHeightDesktop', label: 'Altura linha desktop', type: 'text', placeholder: 'herda do tema' },
      { path: 'lineHeightMobile', label: 'Altura linha mobile', type: 'text', placeholder: 'herda do tema' },
      { path: 'textColor', label: 'Cor do texto', type: 'color' }
    ]
  },
  {
  ...
  },
  {
    ...
    fields: [
      ...
      { path: 'srcMobile', label: 'Imagem mobile (900x1600)', type: 'url', required: true, description: 'Obrigatório para desempenho mobile.' },
  ...
  },
  {
    ...
    fields: [
      ...
      { path: 'srcMobile', label: 'Vídeo mobile (mp4)', type: 'url', required: true, description: 'Versão otimizada para redes móveis.' },
      ...
      { path: 'credit', label: 'Crédito', type: 'text' },
      { path: 'autoplay', label: 'Autoplay', type: 'boolean', helpText: 'Será silenciado no carregamento inicial.' },
  ...
  },
  {
    ...
    fields: [
      ...
      { path: 'videoId', label: 'Video ID fallback', type: 'text', description: 'Usado se os campos específicos não estiverem disponíveis.' },
      ...
      { path: 'aspectRatioMobile', label: 'Aspect ratio mobile', type: 'text', placeholder: '9 / 16' },
  ...
  },
  {
    ...
    fields: [
      { path: 'imagePrefix', label: 'Prefixo desktop', type: 'text', placeholder: 'https://cdn/.../frame_' },
      { path: 'imagePrefixMobile', label: 'Prefixo mobile', type: 'text', placeholder: 'https://cdn/.../mobile/frame_' },
  ...
  },
  {
    ...
    fields: [
      ...
      { path: 'titleColor', label: 'Cor do título', type: 'color' },
      { path: 'textColor', label: 'Cor do texto', type: 'color' },
      { path: 'titleFontSizeDesktop', label: 'Título seção • tamanho desktop', type: 'text', placeholder: 'herda do tema' },
      { path: 'titleFontSizeMobile', label: 'Título seção • tamanho mobile', type: 'text', placeholder: 'herda do tema' },
      { path: 'itemTitleFontSizeDesktop', label: 'Item título • tamanho desktop', type: 'text', placeholder: 'herda do tema' },
      { path: 'itemTitleFontSizeMobile', label: 'Item título • tamanho mobile', type: 'text', placeholder: 'herda do tema' },
      { path: 'itemTextFontSizeDesktop', label: 'Item texto • tamanho desktop', type: 'text', placeholder: 'herda do tema' },
      { path: 'itemTextFontSizeMobile', label: 'Item texto • tamanho mobile', type: 'text', placeholder: 'herda do tema' },
      {
        path: 'items',
        label: 'Itens (JSON)',
        type: 'json',
  ...
  },
  {
    ...
    fields: [
      { path: 'events', label: 'Eventos (JSON)', type: 'json', rows: 10, placeholder: '[{"title":"","date":"","description":""}]', emptyValue: [] },
      {
        path: 'theme',
        label: 'Tema',
        type: 'select',
  ...
  },
  {
    ...
    fields: [
      { path: 'documents', label: 'Documentos (JSON)', type: 'json', rows: 8, placeholder: '[{"title":"","src":"https://..."}]', emptyValue: [] },
      { path: 'classification', label: 'Carimbo de classificação', type: 'text', placeholder: 'CONFIDENCIAL' },
      {
        path: 'theme',
        label: 'Tema',
        type: 'select',
      ...
      { path: 'highlightAreas', label: 'Áreas destacadas (JSON)', type: 'json', rows: 4, placeholder: '[{"page":1,"text":"..."}]', emptyValue: [] },
  ...
  },
  {
    ...
    fields: [
      { path: 'crimes', label: 'Lista de crimes (JSON)', type: 'json', rows: 8, placeholder: '[{"title":"","description":"","penalty":""}]', emptyValue: [] },
      {
        path: 'theme',
        label: 'Tema visual',
        type: 'select',
  ...
  },
  {
    ...
    fields: [
      ...
      { path: 'backgroundColor', label: 'Cor de fundo', type: 'color' },
      { path: 'textColor', label: 'Cor do texto', type: 'color' },
      { path: 'fontSize', label: 'Font size desktop', type: 'text', placeholder: 'clamp(2rem, 5vw, 4rem)' },
      { path: 'fontSizeMobile', label: 'Font size mobile', type: 'text', placeholder: 'clamp(1.6rem, 8vw, 2.8rem)' },
  ...
  },
  {
    ...
    fields: [
      ...
      { path: 'backgroundVideoMobile', label: 'Vídeo mobile', type: 'url' },
      { path: 'backgroundPositionDesktop', label: 'Background position desktop', type: 'text', placeholder: 'center center' },
      { path: 'backgroundPositionMobile', label: 'Background position mobile', type: 'text', placeholder: 'center center' },
      { path: 'backgroundSizeDesktop', label: 'Background size desktop', type: 'text', placeholder: 'cover' },
      { path: 'backgroundSizeMobile', label: 'Background size mobile', type: 'text', placeholder: 'cover' },
      { path: 'textos', label: 'Textos posicionados (JSON)', type: 'json', rows: 10, placeholder: '[{"content":"","fontSize":{"desktop":"4rem"}}]', emptyValue: [] },
      { path: 'imagens', label: 'Imagens posicionadas (JSON)', type: 'json', rows: 8, placeholder: '[{"srcDesktop":"","position":{"desktop":{"x":"10%","y":"20%"}}}]', emptyValue: [] }
    ]
  },
  {
  ...
  },
  {
    ...
    fields: [
      { path: 'id', label: 'ID da âncora', type: 'text', required: true }
    ]
  }
];
