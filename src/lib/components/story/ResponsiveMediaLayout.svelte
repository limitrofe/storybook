<script>
  ...
  function getTextsStyles() {
    return textos.map((texto, index) => {
      const desktop = {
        fontSize: getResponsiveValue(texto.fontSize, 'desktop') || getResponsiveValue(texto.fontSizeDesktop) || '2rem',
        fontWeight: getResponsiveValue(texto.fontWeight, 'desktop') || getResponsiveValue(texto.fontWeightDesktop) || 'normal',
        lineHeight: getResponsiveValue(texto.lineHeight, 'desktop') || getResponsiveValue(texto.lineHeightDesktop) || '1.4',
        textAlign: getResponsiveValue(texto.textAlign, 'desktop') || getResponsiveValue(texto.textAlignDesktop) || 'left',
        letterSpacing: getResponsiveValue(texto.letterSpacing, 'desktop') || getResponsiveValue(texto.letterSpacingDesktop) || '0px',
        ...
        maxWidth: getResponsiveValue(texto.maxWidth, 'desktop') || texto.maxWidthDesktop || 'none',
        minWidth: getResponsiveValue(texto.minWidth, 'desktop') || texto.minWidthDesktop || '0'
      };

      const mobile = {
        fontSize: getResponsiveValue(texto.fontSize, 'mobile') || getResponsiveValue(texto.fontSizeMobile) || desktop.fontSize,
        fontWeight: getResponsiveValue(texto.fontWeight, 'mobile') || getResponsiveValue(texto.fontWeightMobile) || desktop.fontWeight,
        lineHeight: getResponsiveValue(texto.lineHeight, 'mobile') || getResponsiveValue(texto.lineHeightMobile) || desktop.lineHeight,
        textAlign: getResponsiveValue(texto.textAlign, 'mobile') || getResponsiveValue(texto.textAlignMobile) || desktop.textAlign,
        letterSpacing: getResponsiveValue(texto.letterSpacing, 'mobile') || getResponsiveValue(texto.letterSpacingMobile) || desktop.letterSpacing,
        ...
        zIndex: getResponsiveValue(texto.position, 'mobile')?.z || texto.zMobile || desktop.zIndex,
        transform: getResponsiveValue(texto.transform, 'mobile') || texto.transformMobile || desktop.transform,
        width: getResponsiveValue(texto.width, 'mobile') || texto.widthMobile || desktop.width,
        maxWidth: getResponsiveValue(texto.maxWidth, 'mobile') || texto.maxWidthMobile || desktop.maxWidth,
        minWidth: getResponsiveValue(texto.minWidth, 'mobile') || texto.minWidthMobile || desktop.minWidth
      };
  ...
  function getImagesStyles() {
    return imagens.map((imagem, index) => {
      const desktop = {
        ...
        objectFit: getResponsiveValue(imagem.objectFit, 'desktop') || imagem.objectFitDesktop || 'cover',
        ...
        transform: getResponsiveValue(imagem.transform, 'desktop') || imagem.transformDesktop || 'none'
      };

      const mobile = {
        width: getResponsiveValue(imagem.width, 'mobile') || imagem.widthMobile || desktop.width,
        height: getResponsiveValue(imagem.height, 'mobile') || imagem.heightMobile || desktop.height,
        objectFit: getResponsiveValue(imagem.objectFit, 'mobile') || imagem.objectFitMobile || desktop.objectFit,
        ...
        zIndex: getResponsiveValue(imagem.position, 'mobile')?.z || imagem.zMobile || desktop.zIndex,
        transform: getResponsiveValue(imagem.transform, 'mobile') || imagem.transformMobile || desktop.transform
      };
      ...
      <div class="image-element image-{index}">
        <picture>
          ...
          {#if imagem.srcDesktop || imagem.src}
            <source 
              media="(min-width: 769px)" 
              srcset={imagem.srcDesktop || imagem.src}
            >
          {/if}
