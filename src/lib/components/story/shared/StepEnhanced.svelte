...
<script>
  ...
  $: containerStyles = {
    backgroundColor: textConfig.backgroundColor || 'rgba(var(--color-background-rgb), 0.9)',
    ...
    backdropFilter: textConfig.backdropFilter || 'blur(8px)',
    border: textConfig.border || '1px solid var(--color-border)',
    boxShadow: textConfig.boxShadow || '0 8px 30px rgba(0,0,0,0.15)',
