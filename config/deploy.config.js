...
const config = {
  ...
  cdn: {
    baseUrl: process.env.CDN_BASE_URL || 'https://s3.glbimg.com/v1/AUTH_9897f8564b5c46c9b6e85bda5912fe3b',
  ...
  auth: {
    ...
    adminUrl: process.env.ADMIN_URL || 'https://api.s3.globoi.com/v1/AUTH_9897f8564b5c46c9b6e85bda5912fe3b'
  },
